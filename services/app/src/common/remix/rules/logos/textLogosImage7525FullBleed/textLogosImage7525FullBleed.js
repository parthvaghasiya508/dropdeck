...
/**
 * 7525 text + logos + image + full bleed image(s)
 */
export const textLogosImage7525FullBleedRemix = new Remix('textlogosimage-7525-fullbleed', {
  textAlign: 'left',
  ...
  '& .container-logo': {
    ...
    '&[data-length="4"]': {
      '& .element': {
        flex: '0 0 25%',
        padding: '0% 6% 0% 0%', // move padding to right so images align left with text
      },
    },
    ...
    '&[data-length="7"], &[data-length="8"], &[data-length="9"], &[data-length="10"], &[data-length="11"], &[data-length="12"], &[data-length="13"], &[data-length="14"], &[data-length="15"], &[data-length="16"], &[data-length="17"], &[data-length="18"], &[data-length="19"], &[data-length="20"], &[data-length="21"], &[data-length="22"], &[data-length="23"], &[data-length="24"], &[data-length="25"], &[data-length="26"], &[data-length="27"], &[data-length="28"]': {
      '& .element': {
        flex: '0 0 20%',
        padding: '0% 7.5% 0% 0%', // move padding to right so images align left with text
      },
    },
